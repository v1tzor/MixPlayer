 ...
 */
@Entity(tableName = "MixPlayerSettings")
data class MixPlayerSettingsEntity(
    @PrimaryKey(autoGenerate = false) val id: Int = 0,
    @ColumnInfo(name = "language_type") val languageType: LanguageType,
    @ColumnInfo(name = "theme_type") val themeType: ThemeType,
