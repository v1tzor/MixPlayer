...
internal data class SettingsStrings(
    ...
    val generalSettingsHeader: String,
    ...
    companion object {
        ...
        val ENGLISH = SettingsStrings(
            ...
            backDesk = "Назад",
            moreDesk = "Открыть меню",
            resetTitle = "By default",
            defaultTitle = "Default",
            lightTheme = "Light",
            darkTheme = "Dark",
            russianLanguage = "Русский",
            englishLanguage = "English",
            themeDialogTitle = "App theme",
        )
    }
}
