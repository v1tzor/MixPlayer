 ...
 */
internal interface VideoStateCommunicator : StateCommunicator<VideoViewState> {

    class Base @Inject constructor() : VideoStateCommunicator,
        StateCommunicator.Abstract<VideoViewState>(defaultState = VideoViewState())
}
