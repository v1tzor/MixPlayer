...
package ru.aleshin.features.player.impl.presentation.mappers
...
internal fun AudioPlayListType.mapToString() = when (this) {
    AudioPlayListType.SYSTEM -> PlayerThemeRes.strings.systemAudioTitle
    AudioPlayListType.APP -> PlayerThemeRes.strings.appAudioTitle
    AudioPlayListType.OTHER -> name
}