 ...
 */
internal interface AudioStateCommunicator : StateCommunicator<AudioViewState> {

    class Base @Inject constructor() : AudioStateCommunicator,
        StateCommunicator.Abstract<AudioViewState>(defaultState = AudioViewState())
}
