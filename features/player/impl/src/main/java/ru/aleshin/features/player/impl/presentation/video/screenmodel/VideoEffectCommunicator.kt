 ...
 */
internal interface VideoEffectCommunicator : EffectCommunicator<VideoEffect> {

    class Base @Inject constructor() : VideoEffectCommunicator,
        EffectCommunicator.Abstract<VideoEffect>()
}
