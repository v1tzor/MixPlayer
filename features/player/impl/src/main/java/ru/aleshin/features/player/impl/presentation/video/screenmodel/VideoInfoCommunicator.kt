 ...
 */
internal interface VideoInfoCommunicator : Communicator<VideoInfoUi?> {
    class Base @Inject constructor() : VideoInfoCommunicator, Communicator.AbstractStateFlow<VideoInfoUi?>(null)
}