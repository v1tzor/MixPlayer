...
package ru.aleshin.features.player.api.navigation
...
sealed class PlayerScreens {
    data class Audio(val audio: AudioInfoUi, val playListType: AudioPlayListType) : PlayerScreens()
    data class Video(val videoInfoModel: VideoInfoUi) : PlayerScreens()
}
