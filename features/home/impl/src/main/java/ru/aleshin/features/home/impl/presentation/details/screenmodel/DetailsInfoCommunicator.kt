 ...
 */
internal interface DetailsInfoCommunicator : Communicator<AudioPlayListUi?> {
    class Base @Inject constructor() : DetailsInfoCommunicator, Communicator.AbstractStateFlow<AudioPlayListUi?>(null)
}